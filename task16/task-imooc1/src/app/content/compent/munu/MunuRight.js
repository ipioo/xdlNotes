     ...
     let leftindex = this.props.LeftIndex;
        ...
        return (
            <div className="munuRight">
                ...
                <div className={leftindex ? "bannerLeftlist" : "bannerLeftlist d-n"}>
                    {
                        Munudata.bannerLeftlistData.map((val, key)=>{
                            return(
                                <div className={leftindex-1 === key ? "bannerContent" : "bannerContent d-n"} key={key} onMouseEnter={()=>{this.mouseeu(key)}} onMouseOut={()=>{this.mouseeu(0)}}>
                                    {
                                        val[0].map((val,key)=>{
                                            return (
